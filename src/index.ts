...
import { CallToolRequestSchema, ListToolsRequestSchema, ErrorCode, McpError, LATEST_PROTOCOL_VERSION } from '@modelcontextprotocol/sdk/types.js';
...
async function main(): Promise<void> {
	if (config.mode === 'stdio') {
		...
		// Must run BEFORE body parsers to override Accept header before Express caches it
